...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bigpharma_demographics', (
        ...
        db.send_create_signal(u'bigpharma', ['Demographics'])

        # Adding model 'Location'
        db.create_table(u'bigpharma_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
        ...
        db.send_create_signal(u'bigpharma', ['Location'])

        # Adding model 'Allergies'
        db.create_table(u'bigpharma_allergies', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Patient'])),
        ...
        db.send_create_signal(u'bigpharma', ['Allergies'])

        # Adding model 'Diagnosis'
        db.create_table(u'bigpharma_diagnosis', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'])),
            ('provisional', self.gf('django.db.models.fields.BooleanField')()),
        ...
        db.send_create_signal(u'bigpharma', ['Diagnosis'])

        # Adding model 'PastMedicalHistory'
        db.create_table(u'bigpharma_pastmedicalhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'])),
        ...
        db.send_create_signal(u'bigpharma', ['PastMedicalHistory'])

        # Adding model 'Antimicrobial'
        db.create_table(u'bigpharma_antimicrobial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'])),
        ...
        db.send_create_signal(u'bigpharma', ['Antimicrobial'])

        # Adding model 'Investigation'
        db.create_table(u'bigpharma_investigation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('consistency_token', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'])),
        ...
        db.send_create_signal(u'bigpharma', ['Investigation'])


    def backwards(self, orm):
        # Deleting model 'Demographics'
        db.delete_table(u'bigpharma_demographics')

        # Deleting model 'Location'
        db.delete_table(u'bigpharma_location')

        # Deleting model 'Allergies'
        db.delete_table(u'bigpharma_allergies')

        # Deleting model 'Diagnosis'
        db.delete_table(u'bigpharma_diagnosis')

        # Deleting model 'PastMedicalHistory'
        db.delete_table(u'bigpharma_pastmedicalhistory')

        # Deleting model 'Antimicrobial'
        db.delete_table(u'bigpharma_antimicrobial')

        # Deleting model 'Investigation'
        db.delete_table(u'bigpharma_investigation')
