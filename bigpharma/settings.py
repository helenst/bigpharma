# Django settings for bigpharma project.
import commands
import os
import sys
...
ROOT_URLCONF = 'bigpharma.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bigpharma.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('bigpharma.migrations', 'bigpharma.tests',
                            'bigpharma.local_settings',
